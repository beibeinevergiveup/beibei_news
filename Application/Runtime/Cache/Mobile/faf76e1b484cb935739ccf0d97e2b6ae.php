<?php if (!defined('THINK_PATH')) exit(); $Menu = $result['navs']; ?>
<?php
 $config = D("Basic")->select(); $navs = D("Menu")->getBarMenus(); $id = $_GET['id']; if($id){ $flag = D("News")->find($id);} if($flag){ $config['title'] = $flag['title']; } ?>
<!doctype html>
<html class="no-js">
<head>
...
<div data-am-widget="list_news" class="am-list-news am-list-news-default" >
    ...
    <div class="am-list-news-hd am-cf">
        <!--带更多链接-->
        <a class="">
            <h2><?php echo ($Menu['name']); ?>新闻</h2>
        </a>
    </div>
    <div class="am-list-news-bd">
        <ul class="am-list">
            <!--缩略图在标题右边-->
            <?php if(is_array($result['listNews'])): $i = 0; $__LIST__ = $result['listNews'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-right">
