            ...
            <div class="col-lg-6">
                ...
                <form class="form-horizontal" id="singcms-form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" name="user_name" class="form-control" id="inputname" placeholder="请填写用户名">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="real_name" id="inputPassword3" placeholder="请填写真实姓名">
                        </div>
                    </div>
