		...
		<div class="row">
			<div class="col-lg-6">
				...
				<div class="form-group">
					...
					<div class="form-group">
						<label for="inputname" class="col-sm-2 control-label">更新数据库备份:</label>
						<div class="col-sm-5">
							<button type="button" class="btn" id="dump-mysql">确定更新</button>
						</div>
					</div>
				</form>
			</div>
...
<script>
  ...
  $("#dump-mysql").click(function(){
	  ...
	  var url = '/index.php?c=index&a=dumpMysql';
	  var jump_url = '/admin.php?c=basic&a=cache';
	  var postData = {};
