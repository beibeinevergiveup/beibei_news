        ...
        <div class="row">
            ...
            <form id="singcms-form" class="col-sm-4 col-md-4" style="line-height: 200%;margin-top:70px;">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="repassword" placeholder="请重新输入密码" name="repassword">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                <button type="button" class="btn btn-default" onclick="reg.check()">立即注册</button>
                </div>
            </form>
