...
<head>
    <meta charset="utf-8" />
    <title><?php echo ($res[0]["user"]); ?>的留言</title>
...
<div id="contact">
    <h1>用户<?php echo ($res[0]["user"]); ?>的留言</h1>
    <form id="messageform">
        <fieldset>
            <label for="email">Email:</label>
            <input readonly="readonly" type="email" id="email" value="<?php echo ($res[0]["e-mail"]); ?>" name="e-mail" placeholder="告诉我你的邮箱地址" />

            <label for="message">Message:</label>
            <textarea readonly="readonly" id="message" name="message" placeholder="说说你对我们的看法?"><?php echo ($res[0]["message"]); ?></textarea>
            <a href="<?php echo ($url); ?>"><input type="button" value="返回" /></a>
